...
| `models_low_mem/<lang>/` | fp32 (400-token state) + `*_int4.onnx` + `*_int4.onnx.data` (external/separated data) | Low-memory targets (e.g. iOS extensions, older/low-RAM devices) |
